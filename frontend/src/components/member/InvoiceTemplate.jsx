...
const InvoiceTemplate = React.forwardRef(
  ({ member, charges, payments, totalCharges, totalPayments }, ref) => {
    ...
    return (
      <div ref={ref} style={{ padding: '40px', fontFamily: 'Arial, sans-serif' }}>
        <div
          style={{ marginBottom: '40px', borderBottom: '3px solid #1e3a8a', paddingBottom: '20px' }}
        >
          <h1 style={{ fontSize: '32px', margin: '0 0 10px 0', color: '#1e3a8a' }}>
            Member Statement
          </h1>
        ...
        <div style={{ marginBottom: '40px' }}>
          <h2 style={{ fontSize: '18px', marginBottom: '15px', color: '#1e3a8a' }}>
            Member Information
          </h2>
          <div style={{ fontSize: '14px', lineHeight: '1.8', color: '#334155' }}>
            ...
            {(member.member_id || member.id) && (
              <div>
                <strong>Member ID:</strong> {member.member_id || member.id}
              </div>
            )}
            {member.email && (
              <div>
        ...
        >
          <div style={{ fontSize: '16px', color: '#475569', marginBottom: '5px' }}>
            Balance Owed
          </div>
          <div
            style={{
              fontSize: '32px',
              fontWeight: 'bold',
              color: (member.total_owed || 0) > 0 ? '#d97706' : '#059669',
            }}
          >
