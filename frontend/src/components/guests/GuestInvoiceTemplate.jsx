...
const GuestInvoiceTemplate = React.forwardRef(({ guest, transactions, totalCharges, totalPayments }, ref) => {
  ...
  return (
    <div ref={ref} style={{ fontFamily: 'Arial, sans-serif', padding: '40px', maxWidth: '800px', margin: '0 auto' }}>
      {/* Header */}
      <div style={{ marginBottom: '30px', borderBottom: '2px solid #1e3a8a', paddingBottom: '20px' }}>
        <h1 style={{ margin: 0, color: '#1e3a8a', fontSize: '28px' }}>Shtiebel48</h1>
        <h2 style={{ margin: '5px 0 0 0', color: '#64748b', fontSize: '16px', fontWeight: 'normal' }}>Guest Statement</h2>
      </div>
      ...
      <div style={{ marginBottom: '30px', backgroundColor: '#f8fafc', padding: '20px', borderRadius: '8px' }}>
        ...
        <p style={{ margin: '10px 0 0 0', color: '#475569' }}><strong>Statement Date:</strong> {format(new Date(), 'MMMM d, yyyy')}</p>
      </div>

      {/* Charges Section */}
      {charges.length > 0 && (
        <div style={{ marginBottom: '30px' }}>
          <h3 style={{ color: '#334155', borderBottom: '1px solid #e2e8f0', paddingBottom: '10px' }}>Charges</h3>
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            <thead>
              <tr style={{ backgroundColor: '#f8fafc' }}>
                <th style={{ textAlign: 'left', padding: '12px', borderBottom: '1px solid #e2e8f0' }}>Date</th>
                <th style={{ textAlign: 'left', padding: '12px', borderBottom: '1px solid #e2e8f0' }}>Description</th>
                <th style={{ textAlign: 'right', padding: '12px', borderBottom: '1px solid #e2e8f0' }}>Amount</th>
              </tr>
            </thead>
            <tbody>
            ...
            <tfoot>
              <tr style={{ backgroundColor: '#fef3c7' }}>
                <td colSpan="2" style={{ padding: '12px', fontWeight: 'bold' }}>Total Charges</td>
                <td style={{ padding: '12px', textAlign: 'right', fontWeight: 'bold', color: '#d97706' }}>
      ...
      {payments.length > 0 && (
        <div style={{ marginBottom: '30px' }}>
          <h3 style={{ color: '#334155', borderBottom: '1px solid #e2e8f0', paddingBottom: '10px' }}>Payments</h3>
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            <thead>
              <tr style={{ backgroundColor: '#f8fafc' }}>
                <th style={{ textAlign: 'left', padding: '12px', borderBottom: '1px solid #e2e8f0' }}>Date</th>
            ...
            <tfoot>
              <tr style={{ backgroundColor: '#dcfce7' }}>
                <td colSpan="2" style={{ padding: '12px', fontWeight: 'bold' }}>Total Payments</td>
      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <span style={{ fontSize: '18px', fontWeight: 'bold', color: '#334155' }}>Balance Due</span>
          <span style={{ 
            fontSize: '24px', 
            fontWeight: 'bold', 
