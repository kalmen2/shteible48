...
export default function Transactions() {
  ...
  const handleSubmitTransactions = () => {
    const transactions = Object.entries(honorData)
      .filter(([, data]) => data.memberId && data.amount)
      .map(([honor, data]) => {
                        ...
                        <div key={index} className="flex gap-2">
                          ...
                          {newEventHonors.length > 1 && (
                            <Button
                              ...
                              size="icon"
                              onClick={() =>
                                setNewEventHonors(newEventHonors.filter((_, i) => i !== index))
                              }
                              className="h-11 w-11"
                            >
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-slate-50 border-b border-slate-200">
                    <tr>
                      <th className="text-left py-4 px-6 text-sm font-semibold text-slate-700 w-1/4">
                        Honor
                      </th>
                      <th className="text-left py-4 px-6 text-sm font-semibold text-slate-700 w-1/2">
                        Member
                      </th>
                      <th className="text-left py-4 px-6 text-sm font-semibold text-slate-700 w-1/4">
                        Amount
